                ...
                <div role="tabpanel" class="tab-pane fade in active" id="weeka">
                    <div class="panel-body table-responsive">
                        <table class="table table-bordered table-condensed" style="table-layout: fixed; width: 100%">
                            ...
                            <tr>
                                <th id="p1">1</th><td id="MonA1"><?= $timetable->MonA1->lessonName; echo "<br>"; echo $timetable->MonA1->lessonRoom; ?></td><td id="TueA1"><?= $timetable->TueA1->lessonName; echo "<br>"; echo $timetable->TueA1->lessonRoom; ?></td><td id="WedA1"><?= $timetable->WedA1->lessonName; echo "<br>"; echo $timetable->WedA1->lessonRoom; ?></td><td id="ThuA1"><?= $timetable->ThuA1->lessonName; echo "<br>"; echo $timetable->ThuA1->lessonRoom; ?></td><td id="FriA1"><?= $timetable->FriA1->lessonName; echo "<br>"; echo $timetable->FriA1->lessonRoom; ?></td>
                            </tr>
                            <tr>
                                <th id="p2">2</th><td id="MonA2"><?= $timetable->MonA2->lessonName; echo "<br>"; echo $timetable->MonA2->lessonRoom; ?></td><td id="TueA2"><?= $timetable->TueA2->lessonName; echo "<br>"; echo $timetable->TueA2->lessonRoom; ?></td><td id="WedA2"><?= $timetable->WedA2->lessonName; echo "<br>"; echo $timetable->WedA2->lessonRoom; ?></td><td id="ThuA2"><?= $timetable->ThuA2->lessonName; echo "<br>"; echo $timetable->ThuA2->lessonRoom; ?></td><td id="FriA2"><?= $timetable->FriA2->lessonName; echo "<br>"; echo $timetable->FriA2->lessonRoom; ?></td>
                            </tr>
                            <tr>
                                <th id="p3">3</th><td id="MonA3"><?= $timetable->MonA3->lessonName; echo "<br>"; echo $timetable->MonA3->lessonRoom; ?></td><td id="TueA3"><?= $timetable->TueA3->lessonName; echo "<br>"; echo $timetable->TueA3->lessonRoom; ?></td><td id="WedA3"><?= $timetable->WedA3->lessonName; echo "<br>"; echo $timetable->WedA3->lessonRoom; ?></td><td id="ThuA3"><?= $timetable->ThuA3->lessonName; echo "<br>"; echo $timetable->ThuA3->lessonRoom; ?></td><td id="FriA3"><?= $timetable->FriA3->lessonName; echo "<br>"; echo $timetable->FriA3->lessonRoom; ?></td>
                            </tr>
                            <tr>
                                <th id="p4">4</th><td id="MonA4"><?= $timetable->MonA4->lessonName; echo "<br>"; echo $timetable->MonA4->lessonRoom; ?></td><td id="TueA4"><?= $timetable->TueA4->lessonName; echo "<br>"; echo $timetable->TueA4->lessonRoom; ?></td><td id="WedA4"><?= $timetable->WedA4->lessonName; echo "<br>"; echo $timetable->WedA4->lessonRoom; ?></td><td id="ThuA4"><?= $timetable->ThuA4->lessonName; echo "<br>"; echo $timetable->ThuA4->lessonRoom; ?></td><td id="FriA4"><?= $timetable->FriA4->lessonName; echo "<br>"; echo $timetable->FriA4->lessonRoom; ?></td>
                            </tr>
                            <tr>
                                <th id="p5">5</th><td id="MonA5"><?= $timetable->MonA5->lessonName; echo "<br>"; echo $timetable->MonA5->lessonRoom; ?></td><td id="TueA5"><?= $timetable->TueA5->lessonName; echo "<br>"; echo $timetable->TueA5->lessonRoom; ?></td><td id="WedA5"><?= $timetable->WedA5->lessonName; echo "<br>"; echo $timetable->WedA5->lessonRoom; ?></td><td id="ThuA5"><?= $timetable->ThuA5->lessonName; echo "<br>"; echo $timetable->ThuA5->lessonRoom; ?></td><td id="FriA5"><?= $timetable->FriA5->lessonName; echo "<br>"; echo $timetable->FriA5->lessonRoom; ?></td>
                            </tr>
                            <tr>
                                <th id="p6">6</th><td id="MonA6"><?= $timetable->MonA6->lessonName; echo "<br>"; echo $timetable->MonA6->lessonRoom; ?></td><td id="TueA6"><?= $timetable->TueA6->lessonName; echo "<br>"; echo $timetable->TueA6->lessonRoom; ?></td><td id="WedA6"><?= $timetable->WedA6->lessonName; echo "<br>"; echo $timetable->WedA6->lessonRoom; ?></td><td id="ThuA6"><?= $timetable->ThuA6->lessonName; echo "<br>"; echo $timetable->ThuA6->lessonRoom; ?></td><td id="FriA6"><?= $timetable->FriA6->lessonName; echo "<br>"; echo $timetable->FriA6->lessonRoom; ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
